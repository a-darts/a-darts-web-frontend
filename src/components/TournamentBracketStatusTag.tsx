...
interface TournamentBracketStatusTagProps {
  status: TournamentStatus | string;
  size?: 'small' | 'medium';
}

const TournamentBracketStatusTag: React.FC<TournamentBracketStatusTagProps> = ({ status, size = 'small' }) => {
...
export default TournamentBracketStatusTag;
